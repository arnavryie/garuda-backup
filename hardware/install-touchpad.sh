...
echo "==> [3/3] Installing Dynamic Profile & Hardware Thermal Manager (Blue/White/Red/Purple)..."
cp "$SCRIPT_DIR/lenovo-profile-manager.sh" /usr/local/bin/lenovo-profile-manager.sh
chmod +x /usr/local/bin/lenovo-profile-manager.sh
