...
Item {
    ...
    Component.onCompleted: {
        ...
        fullLanguage.append({ name: i18n("Bengali"), code: "bn" });
        fullLanguage.append({ name: i18n("Thai"), code: "th" });
        fullLanguage.append({ name: i18n("Persian (Farsi)"), code: "fa" });
        fullLanguage.append({ name: i18n("Ukrainian"), code: "uk" });
        fullLanguage.append({ name: i18n("Hebrew"), code: "he" });
        fullLanguage.append({ name: i18n("Malay"), code: "ms" });
    }
